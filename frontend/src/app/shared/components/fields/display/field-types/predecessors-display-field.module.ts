...
import { formatPredecessorsList } from './predecessors-format';

export class PredecessorsDisplayField extends DisplayField<WorkPackageResource> {
  ...
  protected get attribute() {
    ...
    return formatPredecessorsList(this.resource, relations);
  }
}
