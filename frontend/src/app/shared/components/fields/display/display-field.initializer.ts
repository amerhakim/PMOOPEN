...
import {
  PredecessorsDisplayField,
} from 'core-app/shared/components/fields/display/field-types/predecessors-display-field.module';
import {
  SuccessorsDisplayField,
} from 'core-app/shared/components/fields/display/field-types/successors-display-field.module';
import {
  ExpectedCompletionDisplayField,
} from 'core-app/shared/components/fields/display/field-types/expected-completion-display-field.module';
...
export function initializeCoreDisplayFields(displayFieldService:DisplayFieldService) {
  return () => {
    ...
    displayFieldService
      ...
      .addSpecificFieldType('WorkPackage', PredecessorsDisplayField, 'predecessors', ['predecessors'])
      .addSpecificFieldType('WorkPackage', SuccessorsDisplayField, 'successors', ['successors'])
