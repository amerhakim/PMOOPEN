Rails.application.routes.draw do
  scope "projects/:project_id", as: "projects" do
    ...
    post   "payment_terms/lines/:line_id/payments/bulk_destroy", to: "payment_terms#bulk_destroy_payments", as: "bulk_destroy_payment_terms_payments"
  end

  get "my/payment_terms", to: "payment_terms#my_projects", as: "my_payment_terms"
  get "my/payment_terms/export", to: "payment_terms#export_my_projects", as: "export_my_payment_terms"
